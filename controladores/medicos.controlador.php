...
class ControladorMedicos {
		...
		if(isset($_POST["nuevoUsuario"])){
			...
			if(preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["nuevoNombre"]) &&
			   ...
			   preg_match('/^[a-zA-Z0-9]+$/', $_POST["nuevoPassword"])){
				...
				//insertar el id del usuario a la tabla secretarias
				echo  "el id es:".$respuesta["id"];	

				$tabla = "secretarias";
				$datos = array("id" => $respuesta["id"]);
				$respuesta = ModeloSecretarias::mdlIngresarSecretaria($tabla, $datos);
	...
	static public function ctrEditarSecretaria(){
	...
	static public function ctrBorrarMedico(){
