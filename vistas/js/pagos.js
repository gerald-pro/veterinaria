...
$(".tablaPagos tbody").on("click", "button.agregarProducto", function(){
	...
	console.log("Hola perros como estan");
		...
		$(this).parent().parent().parent().children(".cajasMetodoPago").html(
			 ...
			 '<div class="col-xs-4" style="padding-left:10px;">'+ 
			 	...
			 	'<div class="input-group">'+ 
			 		...
			 		'<span class="input-group-addon"><i class="ion ion-social-usd" style="padding-left:10px; display: inline-block; margin-right: 10px;"></i></span>'+ 
			 ...
			 '<div class="col-xs-4" id="capturarCambioEfectivo" style="padding-left:10px">'+
