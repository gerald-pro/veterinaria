...
<head>
  ...
  <link rel="shortcut icon" href="vistas/dist/img/veter.jpg" type="image/x-icon">
  <title>BALDELOMAR</title>
...
if (isset($_GET["rutas"])) {
  ...
  if (
    ...
    $_GET["rutas"] == "servicio" ||
    $_GET["rutas"] == "usuarios" ||
    $_GET["rutas"] == "vacunacion" || 
    $_GET["rutas"] == "consultorios" || 
    $_GET["rutas"] == "crear-cita" ||
    $_GET["rutas"] == "citas" || 
    $_GET["rutas"] == "pagos" ||
    $_GET["rutas"] == "crear-pago" ||
    $_GET["rutas"] == "tipo-vacuna" ||
    $_GET["rutas"] == "reporteVacunas" ||
    $_GET["rutas"] == "reporteCitas" ||
    $_GET["rutas"] == "reporteVacunasEntreFechas" ||
    $_GET["rutas"] == "reportes" ||
    $_GET["rutas"] == "salir" ) {
...
<script src="vistas/js/mascota.js"></script>
<script src="vistas/js/servicio.js"></script>
<script src="vistas/js/vacunacion.js"></script>
<script src="vistas/js/tipo-vacuna.js"></script>
<script src="vistas/js/reportes.js"></script>
<script src="vistas/js/consultorio.js"></script>
