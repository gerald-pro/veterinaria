...
class ModeloUsuarios{
	...
	static public function mdlMostrarMedicos($tabla, $item, $valor){
		...
		if($item != null){
			...
			$stmt = Conexion::conectar()->prepare("SELECT * FROM $tabla WHERE $item = :$item AND perfil = 'Veterinario'");
			...
			$stmt = Conexion::conectar()->prepare("SELECT * FROM $tabla WHERE perfil = 'Veterinario'");
